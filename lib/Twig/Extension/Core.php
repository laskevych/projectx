...
{
    if (null === $format) {
        $formats = $env->getExtension('CoreAdmin')->getDateFormat();
...
function twig_date_converter(Twig_Environment $env, $date = null, $timezone = null)
{
    ...
    if (!$timezone) {
        $defaultTimezone = $env->getExtension('CoreAdmin')->getTimezone();
...
{
    $defaults = $env->getExtension('CoreAdmin')->getNumberFormat();
    if (null === $decimal) {
        $decimal = $defaults[0];
    }
